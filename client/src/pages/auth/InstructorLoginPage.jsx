  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-10">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
        ...
        {/* Header Area */}
        <div className="bg-gradient-to-b from-purple-50 to-white pt-10 pb-8 px-8 text-center">
          <div className="mx-auto mb-4 w-16 h-16 rounded-2xl bg-white shadow-md flex items-center justify-center">
            <span className="text-purple-500 text-2xl">👨‍🏫</span>
          </div>
          <h1 className="text-xl font-semibold text-gray-900">Instructor Login</h1>
